...
- > **Note:** The LSTM model (`lstm_model.keras`) is not included in this repo due to size — it can be regenerated by running the training cells in `senti.ipynb`, 
...
- > **Note:** The fine-tuned DistilBERT model (~268MB) is not included in this repo due to GitHub's file size limits .
